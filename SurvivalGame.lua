...
function SurvivalGame.client_onCreate( self )
	if true then
		...
		sm.game.bindChatCommand( "/kelner_on", {}, "cl_onChatCommand", "Use the unlimited inventory" )
...
function SurvivalGame.cl_onChatCommand( self, params )
	...
	elseif params[1] == "/unstoppable" then
	...
	elseif params[1] == "/homelessak" then
...
function SurvivalGame.sv_switchGodMode( self )
	...
	self.network:sendToClients( "client_showMessage", "GODMODE STATUS: " .. ( g_godMode and "You are Queen Elizabeth II" or "You are not Queen Elizabeth II" ) )
end
...
function SurvivalGame.sv_enableRestrictions( self, state )
	...
	self.network:sendToClients( "client_showMessage", ( state and "Authorized Access !" or "Unauthorized Access !"  ) )
end

function SurvivalGame.sv_setLimitedInventory( self, state )
	sm.game.setLimitedInventory( state )
	self.network:sendToClients( "client_showMessage", "INVENTORY STATUS: " .. ( state and "Homeless" or "Kelner"  ) )
end
